...
\fixme{Lav om så eksempelbilledet kun vises en gang, og man forstår at det er dette billede alle eksempler bruger so inddata.}
...
\fixme{Fjernet framebox for at få det til at virke - hvad skal framebox bruges til?}
\begin{figure}[htp]
\centering
%\framebox{
...
\fixme{Sidste eksempelbillede skal være et der viser situationen før der sorteres fra?}
\begin{figure}[htp]
\centering
...
\begin{figure}[htbp]
  ...
  \end{minipage}
  \caption{Den underbelyste nummerplade til venstre deles op i to kvadratiske blokke, og intensiteterne i dem strækkes. Resultatet til højre viser, at hele nummerpladen stadig er et sammenhængende område i modsætning til illustrationen på figur \vref{fig:DetectCStretch-illu2}.}
...
\fixme{Hvor skal vi skrive at metoden er dårlig på hvide biler?}
...
\label{sec_histo}
\fixme{Skal denne metode beskrives?}
