...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{system/illu/frekvensanalyse.png}  
  \caption{Illustration af frekvensanalyse: For den række pixels der er vist nederst i figuren ønsker vi at analysere frekvensen. Ved at måle intensiteterne i rækken af pixels får vi kurven og middelværdien der er angivet i koordinatsystemet. Kurven der repræsenterer intensiteterne i rækken af pixels krydser middelværdien to gange i punkterne \textbf{a} og \textbf{b}. Dette tal bruger vi som et udtryk for frekvensen i området.}
...
Med denne metode får vi det binære billede af interesseomrder der er vist i figur \ref{fig:DetectCStretch-binary}.
