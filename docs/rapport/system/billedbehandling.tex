...
\begin{figure}[htbp]
  ...
  \end{minipage}
  \caption{Den underbelyste nummerplade til venstre deles op i to kvadratiske blokke, og intensiteterne i dem strækkes uafhængigt af hinanden. Resultatet til højre viser, at hele nummerpladen stadig er et sammenhængende område i modsætning til eksemplet på figur \vref{fig:DetectCStretch-illu1} hvor billedet til venstre bliver delt.}
