...
En anden ting der kunne tages højde for er, at nogle metoder, f.eks. \textit{Frekvensanalyse} markerer nummerpladerne som lavere og bredere end de enligt er. I dette tilfælde er den ideelle nummerpladekandidat ikke et område med et bredde/højde-forhold svarende til en nummerplade.
...
Det nuværende system kan vælge ikke ikke sende en nummerpladekandidat videre til separation hvis en tilstrækkelig troværdig nummerpladekandidat ikke eksisterer. Da separationen ikke vil kunne lade sig gøre hvis nummerpladekandidaten ikke er en nummerplade, vil fejlklassificerede nummerplader altså blive afvist i dette trin. Derfor bør lokaliserings-trinnet altid returner den nummerpladekandidat med færrest point.
