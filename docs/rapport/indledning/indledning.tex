...
\item Billederne skal være taget fra en afstand på mellem 2 og 4 meter AFSTAND TIL BILEN uden brug af zoom.
\end{itemize}
...
Vores andet sæt, \textit{testsættet}, består af 600 ANTAL BILLEDER???? billeder. Når systemet er færdigt, afprøver vi det på dette set billeder for at få en indikation af i hvilket omfang vores system kan læse numerplader på "ukendte" billeder.
