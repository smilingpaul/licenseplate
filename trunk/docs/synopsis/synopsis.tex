...
\begin{enumerate}
\item Research: Læse artikler omkring nummerpladegenkendelse samt materiale omkring mønstergenkendelse og billedbehandling. %Denne opgave er estimeret til ca. 45 timer pr. mand.

\item Fotografering: Fotografering af biler med nummerplader. %Denne opgave er estimeret til ca. 10 timer pr. mand.
