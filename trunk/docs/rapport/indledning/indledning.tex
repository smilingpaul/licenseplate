...
For på forhånd at kunne antage noget om størrelserne på de nummerplader vi ønsker at kunne genkende, har vi taget alle billeder fra en afstand på mellem to og fire meter uden brug af zoomfunktion.

\paragraph{Billeder af god kvalitet}
...
Vi har delt vores billeder op i to set. Det ene sæt, bestående af 400 billeder, kalder vi for vores \textit{træningsæt}. Det er billeder i dette sæt vi har analyseret under arbejdet med at udvikle vores software. F.eks. har vi på baggrund af dette set observeret nummerpladernes størrelser så vi har kunnet vurdere nummerpladestørrelser i den type billeder vi arbejder med.

Vores andet sæt, \textit{kontrolsættet}, består af 600 billeder. Dette set har vi brugt til at foretage en form for kontrol af vores færdige system. Det er vores tanke at denne kontrol vi kunne sige noget om i hvor høj grad vi har formået at lave et system der fungerer på ukendte billeder taget med med vores afgrænsninger som beskrevet tidligere. 

HVIS VI HAR LAVET FLERE SET, F.EKS. MED BLITZ, SKAL DET OGSÅ NÆVNES HER.
