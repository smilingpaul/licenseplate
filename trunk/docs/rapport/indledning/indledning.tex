...
Ved at følge en bil fra et sted til et andet på en motorvej kan man ved at analysere gennemsnitshastigheden afsløre fartsyndere. Denne metode er mere robust end metoden hvor man blot foretager en enkelt måling, da billisten kortvarigt kan sætte hstigheden ned hvis vedkommende er opmærksom på at der lokalt bliver foretaget hastighedskontrol.

\paragraph{Statistik}
Brug af veje og andre faciliteter kan analyseres. Hvor mange biler passerer et givent sted i løbet af et døgn? Hvor mange af disse er pendlere der kører den ene vej om morgenen og den anden om aftenen? Hvordan bevæger trafikken sig igenem en by? Hvordan fordeler trafikken sig fra dens indfaldsveje?

\paragraph{Trafikafgift}\footnote{Eng.: Roadpricing}
Både London og Stockholm har i skrivende stund systemer der registrerer køretøjer der kører ind og ud ad byen. Ejerne af køretøjer der bevæger sig i den indre by, får tilsendt en bøde hvis de ikke betaler for den tid de bruger i midtbyen.

\paragraph{Patruljering}
Med kameraer monteret på patruljevogne kan politiet registrere om de passerer for eksempel efterlyste køretøjer. Demonstrationen af et sådan system kan ses i \cite{canada_demo}. 
...
For at kunne automatisere afprøvning af vores system, har vi navngivet vores billedfiler så vi kan aflæse nummerpladens koordinater samt nummerpladens tekst. HVORDAN?
