...
Derudover slettes alle pixels i de rækker af billedet som ikke har mindst $\frac{1}{10}$ eller højst $\frac{2}{3}$ af alle pixels i billedets bredde markeret. Dette gøres fordi en linie som går i gennem alle tegn vil ligge i dette område, alle andre linier kan derfor sorteres fra. Man kunne overveje at gøre det i den vertikale retning, men vores undersøgelser viste at dette ofte "skærer" tegnet \textbf{K} over, da det er meget smalt i midten.
