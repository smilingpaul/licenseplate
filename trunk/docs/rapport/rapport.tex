...
\label{sec:illu:1}
\subsection{Roterede nummerplader}
Billederne i dette afsnit viser nummerplader som det ser ud når det er klippet ud og roteret. Det er disse billeder der er inddata når tegnene i nummerpladerne skal separeres.
