...
\caption{Inddata, i form af et billede af en bil med nummerplader samt koordinaterne til denne plade, kommer ind i denne del af systemet fra venstre. Funktionerne roterer pladen, separerer tegnene og udklipper disse. Uddata er syv binære billeder med de syv tegn. Separationsmetoden i den grå kasse er ikke med i det vi definerer som ``vores færdige system''.}
\label{fig:dia_trin2}
\end{figure}
