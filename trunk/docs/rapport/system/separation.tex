...
\begin{figure}[htp]
  \centering
  \framebox{\includegraphics[width=8cm]{system/illu/radon.png}}
...
\paragraph{1. Hvert tegn fylder maksimalt $\frac{1}{7}$ af billedet/pladen:} Da en nummerplade består af syv tegn og noget baggrund vil ingen tegn fylde mere end $\frac{1}{7}$ af pladen. 
\paragraph{2. Hvert tegn har en maksimal bredde på $\frac{1}{7}$ af billedets/pladens bredde:} Denne regel er lavet ud fra samme argument som ovenfor.
