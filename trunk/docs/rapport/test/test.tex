...
I figurerne \vref{fig:test:genkend_traening_tal}, \vref{fig:test:genkend_traening_bogstav}, \vref{fig:test:genkend_kontrol_tal} samt \vref{fig:test:genkend_kontrol_bogstav} ses resultaterne af afprøvningen af genkendelse af tegn. Resultaterne er delt op i tal- og bogstavtabeller.
