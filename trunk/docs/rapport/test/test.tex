...
I dette afsnit afprøver vi hvor god vores software er til at lokalisere nummerplader når alle fem metoder arbejder sammen. Vi har foretaget afprøvningen med to forskellige indstillinger for minimal enighed. Hvor god er softwaren når det ikke er et krav at flere metoder skal udpege samme område? Hvor god er softwaren når mindst to metoder skal udpege samme område for at vi betragter det som en nummerplade? Resultaterne for afprøvningerne på træningsættet er vist på figur \vref{fig:test:lokalisering_traening_samlet} og de tilsvarende resultater for kontrolsættet er vist i figur \ref{fig:test:lokalisering_kontrol_samlet}
